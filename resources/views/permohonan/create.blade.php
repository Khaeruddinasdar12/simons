            ...
            <form action="{{ route('permohonan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid cols-2">
                    ...
                    <div style="grid-column: 1 / -1;">
                        <label class="label" for="alamat_lengkap">Alamat Lengkap</label>
                    ...
                    <div>
                        <label class="label" for="program_studi">Program Studi</label>
                ...
                <div class="grid cols-2">
                    <div style="grid-column: 1 / -1;">
                        <label class="label" for="judul_skripsi">Judul Skripsi</label>
                    ...
                    <div>
                        <label class="label" for="pembimbing_1">Pembimbing 1</label>
                        <input id="pembimbing_1" name="pembimbing_1" type="text" value="{{ old('pembimbing_1') }}" class="field" required>
                        @error('pembimbing_1') <p class="error">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="label" for="pembimbing_2">Pembimbing 2</label>
                        <input id="pembimbing_2" name="pembimbing_2" type="text" value="{{ old('pembimbing_2') }}" class="field" required>
                        @error('pembimbing_2') <p class="error">{{ $message }}</p> @enderror
                    </div>
                    <div style="grid-column: 1 / -1;">
                        <label class="label" for="file_usul_pembimbing">Upload Usul Pembimbing dari Prodi</label>
                        <input id="file_usul_pembimbing" name="file_usul_pembimbing" type="file"
                               accept=".pdf,.jpg,.jpeg,.png" class="field" required>
                        <p style="margin:.4rem 0 0;font-size:.8rem;color:var(--muted);">PDF / JPG / PNG, maksimal 5 MB.</p>
