...
<body class="{{ ! empty($isBrowserPreview) ? 'sk-browser-preview' : '' }}">
    ...
    <div class="center">
        ...
        <p class="tentang">TENTANG<br>PENETAPAN SK PENGUJI SKRIPSI</p>
    ...
    <table class="meta" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="label" width="120" valign="top">Membaca</td>
            <td class="colon" width="14" valign="top">:</td>
            <td valign="top">
                ...
                <table class="kv" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="k" width="110" valign="top">Nama</td>
                        <td class="c" width="14" valign="top">:</td>
                        <td valign="top">{{ $namaMhs }}</td>
                    </tr>
                    <tr>
                        <td class="k" width="110" valign="top">NIM</td>
                        <td class="c" width="14" valign="top">:</td>
                        <td valign="top">{{ $nimMhs }}</td>
                    </tr>
                    <tr>
                        <td class="k" width="110" valign="top">Prodi</td>
                        <td class="c" width="14" valign="top">:</td>
                        <td valign="top">{{ $prodiLengkap }}</td>
                    </tr>
                    <tr>
                        <td class="k" width="110" valign="top">Judul Skripsi</td>
                        <td class="c" width="14" valign="top">:</td>
        ...
        <tr>
            <td class="label" width="120" valign="top">Menimbang</td>
            <td class="colon" width="14" valign="top">:</td>
            <td valign="top">
                <table class="olist" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="n" width="18" valign="top">1.</td>
                    ...
                    <tr>
                        <td class="n" width="18" valign="top">2.</td>
                        <td valign="top">
                            Bahwa menunjuk Saudara:
                            <table class="kv" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="k" width="110" valign="top">Penguji 1</td>
                                    <td class="c" width="14" valign="top">:</td>
                                    <td class="bold" valign="top">{{ $permohonan->penguji_1 }}</td>
                                </tr>
                                <tr>
                                    <td class="k" width="110" valign="top">Penguji 2</td>
                                    <td class="c" width="14" valign="top">:</td>
                                    <td class="bold" valign="top">{{ $permohonan->penguji_2 }}</td>
                                </tr>
                            </table>
                            dipandang cakap dan memenuhi syarat untuk diangkat sebagai Penguji Skripsi Prodi {{ $prodiLengkap }} Fakultas Syariah dan Hukum Islam IAIN Bone.
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="label" width="120" valign="top">Mengingat</td>
            <td class="colon" width="14" valign="top">:</td>
            <td class="small" valign="top">
                <table class="olist" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="n" width="18" valign="top">5.</td>
                    ...
                    <tr>
                        <td class="n" width="18" valign="top">6.</td>
                    ...
                    <tr>
                        <td class="n" width="18" valign="top">7.</td>
                    ...
                    <tr>
                        <td class="n" width="18" valign="top">8.</td>
                    ...
                    <tr>
                        <td class="n" width="18" valign="top">9.</td>
        ...
        <tr>
            <td class="label" width="120" valign="top">Memperhatikan</td>
            <td class="colon" width="14" valign="top">:</td>
    ...
    <table class="meta" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="label" width="120" valign="top">Menetapkan</td>
            <td class="colon" width="14" valign="top">:</td>
            <td valign="top">
    ...
    <table class="dict" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="dict-key" width="120" valign="top">KESATU</td>
            <td class="dict-colon" width="14" valign="top">:</td>
        ...
        <tr>
            <td class="dict-key" width="120" valign="top">KEDUA</td>
            <td class="dict-colon" width="14" valign="top">:</td>
            <td class="dict-val" valign="top">
        ...
        <tr>
            <td class="dict-key" width="120" valign="top">KETIGA</td>
            <td class="dict-colon" width="14" valign="top">:</td>
            <td class="dict-val" valign="top">
