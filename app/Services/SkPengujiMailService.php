...
use App\Mail\SkPengujiTerbitMail;
...
class SkPengujiMailService
{
    ...
    public function sendTerbitNotification(PermohonanPenguji $permohonan): string
    {
        ...
        try {
            Mail::to($email)->send(new SkPengujiTerbitMail($permohonan));

            Log::info('Email SK Penguji berhasil dikirim', [
                'permohonan_id' => $permohonan->id,
                'email' => $email,
            ...
            Log::error('Gagal kirim email SK Penguji', [
                'permohonan_id' => $permohonan->id,
                'email' => $email,
                'error' => $e->getMessage(),
            ]);
